...
void invo_uart_register_grid(lv_obj_t * grid_v, lv_obj_t * batt_v, lv_obj_t * grid_hz, lv_obj_t * grid_w,
...
void invo_uart_register_inverter_screen(lv_obj_t * out_v, lv_obj_t * out_hz, lv_obj_t * out_w, lv_obj_t * grid_v,
                                        lv_obj_t * grid_hz, lv_obj_t * grid_w, lv_obj_t * grid_a, lv_obj_t * batt_v,
                                        lv_obj_t * batt_a, lv_obj_t * batt_temp, lv_obj_t * inv_on, lv_obj_t * bypass,
                                        lv_obj_t * ac_chg, lv_obj_t * fault);
void invo_uart_init(void);
void invo_uart_get_live(float * batt_pct, float * solar_kw, float * load_kw, int * fault, int * bypassing, int * inv_on,
                        float * batt_temp);
